#!/usr/bin/python3
"""
Ce programme ainsi que les fichiers présents dans ce répertoire sont
une application du tutoriel disponible à
http://python.developpez.com/cours/apprendre-python3/?page=page_19#L19-B

Quelques indentations ont dû être rétablies de façon logique,
et le modèle spectacles.htm a du être légèrement modifié sans quoi
on ne pouvait pas finaliser le "panier".
"""
